...
namespace CoreServices.Logic
{
    public class AccountTeamServices
    {
        ...
        {
            _repository.AccountTeam.UpdateAccountTeamGold(fk_AccountTeam, fk_Season);
        }
            ...
            return _repository.AccountTeamPlayer
                       ...
                       .Select(a => new AccountTeamPlayerModel
                       {
                           ...
                           AccountTeamPlayerGameWeak = parameters.IsCurrent == true ?
                                       a.AccountTeamPlayerGameWeaks.Where(b => b.GameWeak.IsCurrent && b.Fk_GameWeak == parameters.Fk_GameWeak)
                                       ...
                                       a.AccountTeamPlayerGameWeaks.Where(b => b.GameWeak.IsNext && b.Fk_GameWeak == parameters.Fk_GameWeak)
                                       .Select(b => new AccountTeamPlayerGameWeakModel
                                       {
                                           Id = b.Id,
                                           Fk_AccountTeamPlayer = b.Fk_AccountTeamPlayer,
