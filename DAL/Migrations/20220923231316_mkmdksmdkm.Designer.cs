...
namespace DAL.Migrations
{
    ...
    [Migration("20220923231316_mkmdksmdkm")]
    partial class mkmdksmdkm
    {
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerScoreModels.PlayerGameWeak", b =>
                {
                    ...
                    b.HasIndex("Fk_GameWeak", "Fk_Player")
                        .IsUnique();
            ...
            modelBuilder.Entity("Entities.DBModels.SeasonModels.TeamGameWeak", b =>
                {
                    ...
                    b.Property<string>("_365_MatchUpId")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Developer",
                            Password = "$2a$11$TOhUTTK0HXBZXzlAAS0Cgu2eF1GCJbsC8OgnBkcLiaJQBYfaOkQBi",
                            UserName = "Developer"
                        });
                });
