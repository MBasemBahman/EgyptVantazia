...
namespace DAL.Migrations
{
    ...
    [Migration("20221028171051_mkmkmkm")]
    partial class mkmkmkm
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerStateModels.ScoreState", b =>
                {
                    ...
                    b.Property<int?>("ScoreTypeLangId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerStateModels.ScoreStateLang", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9496),
                            Fk_Source = 1,
                            Name = "Total"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9508),
                            Fk_Source = 2,
                            Name = "CleanSheet"
                        },
                        new
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9511),
                            Fk_Source = 3,
                            Name = "Goals"
                        },
                        new
                        {
                            Id = 4,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9513),
                            Fk_Source = 4,
                            Name = "Assists"
                        },
                        new
                        {
                            Id = 5,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9515),
                            Fk_Source = 5,
                            Name = "GoalkeeperSaves"
                        },
                        new
                        {
                            Id = 6,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9518),
                            Fk_Source = 6,
                            Name = "PenaltiesSaved"
                        },
                        new
                        {
                            Id = 7,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9521),
                            Fk_Source = 7,
                            Name = "YellowCard"
                        },
                        new
                        {
                            Id = 8,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9523),
                            Fk_Source = 8,
                            Name = "RedCard"
                        },
                        new
                        {
                            Id = 9,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9525),
                            Fk_Source = 9,
                            Name = "BuyingPrice"
                        },
                        new
                        {
                            Id = 10,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9528),
                            Fk_Source = 10,
                            Name = "SellingPrice"
                        },
                        new
                        {
                            Id = 11,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9530),
                            Fk_Source = 11,
                            Name = "BuyingCount"
                        },
                        new
                        {
                            Id = 12,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9532),
                            Fk_Source = 12,
                            Name = "SellingCount"
                        },
                        new
                        {
                            Id = 13,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9540),
                            Fk_Source = 13,
                            Name = "PlayerSelection"
                        },
                        new
                        {
                            Id = 14,
                            CreatedAt = new DateTime(2022, 10, 28, 17, 10, 50, 438, DateTimeKind.Utc).AddTicks(9543),
                            Fk_Source = 14,
                            Name = "PlayerCaptain"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Developer",
                            Password = "$2a$11$LI6YkwfOom/wy6D5ffk28u6ajscjVfg4SxAZt7qrJm85qZZnWErkW",
                            UserName = "Developer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerStateModels.ScoreState", b =>
                {
                    b.HasOne("Entities.DBModels.PlayerScoreModels.ScoreTypeLang", "ScoreTypeLang")
                        .WithMany()
                        .HasForeignKey("ScoreTypeLangId");
