...
namespace DAL.Migrations
{
    ...
    [Migration("20221230220550_kmkdkmskmdkmd")]
    partial class kmkdkmskmdkmd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DBModels.AccountModels.AccountRefCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("Fk_NewAccount")
                        .HasColumnType("int");

                    b.Property<int>("Fk_RefAccount")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("Fk_NewAccount")
                        .IsUnique();

                    b.HasIndex("Fk_RefAccount");

                    b.HasIndex("Fk_NewAccount", "Fk_RefAccount")
                        .IsUnique();

                    b.ToTable("AccountRefCode");
                });
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Developer",
                            Password = "$2a$11$D9e.o3DrrzJ/IM9PI.ebM.6uQ0urTMRbpYMw4ITaAAIhKCOSY7X/i",
                            UserName = "Developer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.AccountModels.AccountRefCode", b =>
                {
                    b.HasOne("Entities.DBModels.AccountModels.Account", "NewAccount")
                        .WithOne("NewAccountRefCode")
                        .HasForeignKey("Entities.DBModels.AccountModels.AccountRefCode", "Fk_NewAccount")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Entities.DBModels.AccountModels.Account", "RefAccount")
                        .WithMany("RefAccountsRefCode")
                        .HasForeignKey("Fk_RefAccount")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Entities.DBModels.AccountModels.Account", b =>
                {
                    ...
                    b.Navigation("NewAccountRefCode");

                    b.Navigation("Payments");

                    b.Navigation("PrivateLeagueMembers");

                    b.Navigation("RefAccountsRefCode");
                });
