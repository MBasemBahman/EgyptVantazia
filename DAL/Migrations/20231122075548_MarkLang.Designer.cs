...
namespace DAL.Migrations
{
    ...
    [Migration("20231122075548_MarkLang")]
    partial class MarkLang
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.DBModels.AccountTeamModels.AccountTeam", b =>
                {
                    ...
                    b.Property<bool>("HaveGoldSubscription")
                        .HasColumnType("bit");
                    ...
                    b.Property<double>("TotalTeamPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerMarkModels.PlayerMarkLang", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Entities.DBModels.UserModels.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Name = "Developer",
                            Password = "$2a$11$tc0WdSv56UwZYZaxBh2bHOqr5LC7r2E.WQJtTtWmG0WtTIBp3YPpS",
                            UserName = "Developer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.DBModels.PlayerMarkModels.PlayerMarkLang", b =>
                {
                    b.HasOne("Entities.DBModels.PlayerMarkModels.PlayerMark", "Source")
                        .WithOne("PlayerMarkLang")
                        .HasForeignKey("Entities.DBModels.PlayerMarkModels.PlayerMarkLang", "Fk_Source")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
