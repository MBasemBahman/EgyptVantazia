...
{
    public class PlayerMarkReasonMatchParameters : RequestParameters
    {
    ...
    public class PlayerMarkReasonMatchModel : AuditEntity
    {
        [DisplayName(nameof(PlayerMark))]
        [ForeignKey(nameof(PlayerMark))]
        public int Fk_PlayerMark { get; set; }
    ...
    public class PlayerMarkReasonMatchCreateOrEditModel
    {
        [DisplayName(nameof(PlayerMark))]
        [ForeignKey(nameof(PlayerMark))]
        public int Fk_PlayerMark { get; set; }
